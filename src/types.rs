...
pub struct CreateResponseBody {
    ...
    pub input: Option<CreateResponseBodyInput>,
...
#[derive(Debug, Clone, PartialEq, Serialize, oas3_gen_support::Default)]
#[serde(untagged)]
pub enum CreateResponseBodyInput {
    ...
    #[default]
    Variant0(CreateResponseBodyInputVariant0),
}
/// Context to provide to the model for the scope of this request. May either be a string or an array of input items. If a string is provided, it is interpreted as a user message.
#[derive(Debug, Clone, PartialEq, Serialize, oas3_gen_support::Default)]
#[serde(untagged)]
pub enum CreateResponseBodyInputVariant0 {
    #[default]
    String(String),
    Array(Vec<ItemParam>),
}
...
pub struct ResponseResource {
    ...
    pub tool_choice: ToolChoiceValueEnum,
